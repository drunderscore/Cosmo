...
public:
    ...
    virtual void EmitSound( IRecipientFilter& filter, int iEntIndex, int iChannel, const char *pSample,
                           ...
                           const Cosmo::SourceVector *pOrigin = NULL, const Cosmo::SourceVector *pDirection = NULL, CUtlVector< Cosmo::SourceVector >* pUtlVecOrigins = NULL, bool bUpdatePositions = true, float soundtime = 0.0f, int speakerentity = -1 ) = 0;
